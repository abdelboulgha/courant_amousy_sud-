...
export const translations = {
  fr: {
    ...
    hero: {
      ...
      h1a: "L'énergie et",
      h1b: "l'expertise",
      h1c: "au service de vos projets",
      sub: "Électricité, plomberie, climatisation, vidéosurveillance, alarmes et travaux divers — des solutions fiables et modernes.",
  ...
  ar: {
    ...
    hero: {
      ...
      h1a: "الطاقة",
      h1b: "والخبرة",
      h1c: "في خدمة مشاريعكم",
      sub: "كهرباء، سباكة، تكييف، مراقبة بالكاميرات، إنذار وأعمال متنوعة — حلول موثوقة وعصرية.",
      btn1: "اكتشف خدماتنا",
      btn2: "تواصل",
      scroll: "تمرير",
    },
