    ...
    <section ref={sectionRef} className="cta-glow py-24 relative overflow-hidden" style={{ background: "#5319c6" }} dir={isRTL ? "rtl" : "ltr"}>
      ...
      <div className="relative max-w-3xl mx-auto px-6 lg:px-8 text-center">
        <div ref={innerRef} className="flex flex-col items-center gap-6">
          ...
          {/* Badge */}
          <div className="text-xs font-bold uppercase tracking-[0.25em]" style={{ color: "rgba(255,255,255,0.5)" }}>
            {t.cta.label}
          </div>
          ...
          {/* Subtitle */}
          <p className="text-base leading-relaxed" style={{ color: "rgba(255,255,255,0.65)", maxWidth: 460 }}>
            {t.cta.sub}
          </p>

          {/* Button */}
          <Link href="/contact"
            className="inline-flex items-center gap-3 px-10 py-4 text-sm font-black uppercase tracking-widest transition-all duration-200"
